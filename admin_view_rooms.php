...
// Make the query:
$q = "SELECT ref_num, thumb, price, mini_descr, n_room, status FROM houses ORDER BY ref_num ASC LIMIT $start, $pagerows";		
...
if ($current_page != 1) {
echo '<a href="admin_view_rooms.php?s=' . ($start - $pagerows) . '&p=' . $pages . '">Previous</a> ';
}
//Create a Next link
if ($current_page != $pages) {
echo '<a href="admin_view_rooms.php?s=' . ($start + $pagerows) . '&p=' . $pages . '">Next</a> ';
}
echo '</p>';
}
?>
